...
from pymarl_src.modules.critics.coma import COMACritic
from pymarl_src.utils.rl_utils import build_td_lambda_targets
...
class COMALearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.agent_optimiser = optim.RMSprop(params=self.agent_params, lr=args.lr, alpha=args.optim_alpha,
                                             eps=args.optim_eps)
        self.critic_optimiser = optim.RMSprop(params=self.critic_params, lr=args.critic_lr, alpha=args.optim_alpha,
                                              eps=args.optim_eps)
